...
import { ProfessionalAssignmentModal } from "./shared/ProfessionalAssignmentModal";
    ...
    >
      ...
      {firstImage && (
        <div className="my-3 w-48 h-32 overflow-hidden rounded-lg border border-gray-200">
          <img
            src={`https://api.in2skincare.com/${firstImage.image_url}`}
  ...
  return (
    <div className="p-8">
      ...
      <ProfessionalAssignmentModal
        ...
        consultationId={assignmentConsultationId || 0}
