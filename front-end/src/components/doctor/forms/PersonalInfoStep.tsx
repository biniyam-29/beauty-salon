...
import { Input, Label } from "./PatientUpdateComponents";

export const PersonalInfoStep: React.FC<StepProps> = ({ formData, updateFormData, isEditing = false }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
      ...
      <Input
        ...
        required
        disabled={isEditing} // Don't allow phone change in edit mode
      />
    </div>
